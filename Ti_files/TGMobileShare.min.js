/** @author:dereksu @description:http://km.oa.com/group/TGideas/articles/show/243512 @update:2019.01.11 @version:v2.12 **/
var TGMS = function() {
	var b = {
		isLoadedJs: false,
		isFirstInit: false,
	...
	var e = {
		...
		tcssImgLoader: function(i, h) {
			var g = document.createElement("img"),
				f = "https://pingfore.qq.com/pingd?dm=" + i + ".hot&url=/&arg=-&hottag=" + encodeURIComponent(h) + "&hotx=9999&hoty=9999&rand=" + Math.random() + "&tgmobileshare=1";
	...
	var d = {
		...
		getSeoData: function() {
			...
			c.seoData.description = e.getMetaData("Description") ? e.getMetaData("Description") : e.getMetaData("description")
		},
		getTgmData: function() {
			...
			c.tgmData.shareLink = e.getMetaData("tgm:shareLink") ? e.getMetaData("tgm:shareLink") == window.location.href ? e.delQueStr(window.location.href, "ADTAG") : e.getMetaData("tgm:shareLink") : e.delQueStr(window.location.href, "ADTAG");
		...
		setShareInfo: function(f) {
			if(!e.checkObjType(f)) {
				...
				c.shareData.shareLink = f.shareLink ? f.shareLink == window.location.href ? e.delQueStr(window.location.href, "ADTAG") : f.shareLink : c.tgmData.shareLink;
		...
		initWXShare: function(j, n, l) {
			if(n) {
				...
				var h = ["onMenuShareAppMessage", "onMenuShareTimeline", "onMenuShareQQ", "onMenuShareWeibo", "onMenuShareQZone"];
				for(var k = 0; k < g.length; k++) {
					l[h[k]]({
						title: h[k] == "onMenuShareAppMessage" && c.shareData.messageTitle ? c.shareData.messageTitle : h[k] == "onMenuShareTimeline" && c.shareData.timelineTitle ? c.shareData.timelineTitle : c.shareData.shareTitle,
						desc: h[k] == "onMenuShareAppMessage" && c.shareData.messageDesc ? c.shareData.messageDesc : c.shareData.shareDesc,
			...
			mqq.device.isMobileQQ(function(h) {
				...
				if(!b.isFirstInit) {
					...
					c.onInitInfo.qzoneShare = function() {
						...
						setTimeout(function() {
							window.location.href = "https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" + encodeURIComponent(e.urlFix(c.shareData.shareLink, "tgi.browser.share.qzone")) + "&title=" + encodeURIComponent(c.shareData.shareTitle) + "&summary=" + encodeURIComponent(c.shareData.shareDesc) + "&pics=" + encodeURIComponent(c.shareData.shareImgUrl) + "&desc=%E8%B5%9E%EF%BC%81%EF%BC%81" + "&site=" + window.location.hostname
						}, 220)
					};
					c.onInitInfo.sinaWeiboShare = function() {
						...
						setTimeout(function() {
							window.location.href = "http://service.weibo.com/share/share.php?url=" + encodeURIComponent(e.urlFix(c.shareData.shareLink, "tgi.browser.share.sinaweibo")) + "&title=" + encodeURIComponent(c.shareData.shareTitle) + "&pic=" + encodeURIComponent(c.shareData.shareImgUrl)
						}, 220)
					};
					c.onInitInfo.qqWeiboShare = function() {
						...
						setTimeout(function() {
							window.location.href = "http://share.v.t.qq.com/index.php?c=share&a=index&url=" + encodeURIComponent(e.urlFix(c.shareData.shareLink, "tgi.browser.share.qqweibo")) + "&title=" + encodeURIComponent(c.shareData.shareTitle) + "&pic=" + encodeURIComponent(c.shareData.shareImgUrl)
						}, 220)
					};
					if(e.checkObjType(f)) {
		...
		startRun: function(n) {
			if(!b.isLoadedJs) {
				...
				if((typeof(mqq) == "object") && (typeof(mqq.device) == "object") && (e.checkFunType(mqq.device.isMobileQQ)) && (e.checkFunType(mqq.device.getNetworkType)) && (typeof(mqq.ui) == "object") && (e.checkFunType(mqq.ui.setOnShareHandler)) && (e.checkFunType(mqq.ui.shareMessage))) {
					d.initMQQShare(n)
				} else {
		...
		printTips: function(f) {
			if(!(e.checkObjType(f) && f.openConsole === false)) {
				...
				console.log("%c--------------------SHARE START--------------------\n%cTGMobileShareJS\u63d0\u793a\n%c\u5206\u4eab\u6807\u9898\uff1a%c" + c.shareData.shareTitle + "\n%c\u5206\u4eab\u8be6\u60c5\uff1a%c" + c.shareData.shareDesc + "\n%c\u5206\u4eab\u56fe\u7247\uff1a%c" + c.shareData.shareImgUrl + "\n%c\u5206\u4eab\u94fe\u63a5\uff1a%c" + c.shareData.shareLink + "\n%c\u70b9\u0020\u51fb\u0020\u6d41\uff1a%c" + c.shareData.actName + "\n%c\u6587\u0020\u4ef6\u0020\u540d\uff1a%c" + b.fileName + "\n%c--------------------SHARE END--------------------", "color:#989a9d;", "font-size:20px;", "color:#000;", "color:green;", "color:#000;", "color:green;", "color:#000;", "color:green;", "color:#000;", "color:green;", "color:#000;", "color:green;", "color:#000;", "color:green;", "color:#989a9d;")
			}
		},
